...
class ChatLinkPreviewView extends StatelessWidget {
  ...
  static Future<void> open(String value) async {
    ...
    if (uri == null || !['https', 'http'].contains(uri.scheme) || uri.host.isEmpty) return;
    await launchUrl(uri, mode: LaunchMode.externalApplication);
  }
  @override
  Widget build(BuildContext context) => Card(child: ListTile(
    leading: const Icon(Icons.link), title: Text(preview.title, maxLines: 2, overflow: TextOverflow.ellipsis),

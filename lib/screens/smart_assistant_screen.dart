...
class _SmartAssistantScreenState extends State<SmartAssistantScreen> {
  ...
  void initState() {
    ...
    _messages.add(
      ChatMessage(
        text:
            'مرحباً بك! أنا مساعد إداري مجاني يعمل من بيانات النظام مباشرة.\nاسأل عن الغياب، الحضور، الطلبات، المهام، الرواتب، أو طريقة إضافة فريق كامل.',
        isUser: false,
      ),
    );
  }
  ...
  Future<void> _sendMessage() async {
    ...
    if (user != null) {
      try {
        ...
        setState(() {
          _messages.add(
            ChatMessage(text: 'حدث خطأ أثناء معالجة طلبك.', isUser: false),
          );
        });
      }
    }
    ...
    return Align(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: msg.isUser
                ? ZaWolfColors.primaryCyan.withValues(alpha: 0.5)
        ...
        children: [
          Expanded(
            child: WolfInputField(
              ...
              hintText: 'مثال: مين غايب اليوم؟ أو ازاي أضيف فريق اختبار؟',
